  ...
  const features = [
    {
      ...
      description:
        "PLAN YOUR TRIPS WITH AI-RECOMMENDED SUGGESTIONS.",
    ...
    },
    {
      ...
      description:
        "BROWSE HIGH QUALITY IMAGES OF DIFFERENT LOCATIONS, CULTURES AND LANDSCAPES.",
...
const FeatureCard = ({
  ...
  return (
    <div className={cn(`p-2 sm:p-2 relative overflow-hidden`, className)}>
      {children}
    </div>
  );
};
